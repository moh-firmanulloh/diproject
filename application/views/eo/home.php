<script src="<?php echo base_url('assets/js/jssor.slider-25.2.0.min.js') ?>" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:350px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="loading" class="jssorl-004-double-tail-spin" style="position:absolute;top:0px;left:0px;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<?php echo base_url('assets/img/double-tail-spin.svg') ?>" />
        </div>
    ...
    <div class="container" style="padding-top: 40px;">
        <h3><strong>Mengapa memilih Dinian ?</strong></h3>
